...
export const translations = {
  en: {
    ...
    hero: {
      ...
      subcopy: 'NEWFRAME is an independent digital studio shaping distinctive websites, digital identities and product-facing experiences for founders and growing businesses.',
      primaryCta: 'Send your current site',
      secondaryCta: 'View work',
    },
    about: {
      label: 'ABOUT',
      manifesto: `NEWFRAME is an independent digital studio creating sharp, distinctive websites and digital identities for founders and growing businesses. We work with companies that understand how strongly perception shapes trust, pricing and growth.`,
      manifestoHighlights: ['NEWFRAME', 'digital', 'studio', 'perception'],
    ...
    testimonials: {
      ...
      items: [
        {
          lead: 'The website sold them before they even walked in.',
          quote: "NEWFRAME took our vision and turned it into something we're genuinely proud to show people. The site feels like us, not some generic template with our logo slapped on. We've had clients tell us the website sold them before they even walked in.",
        ...
        },
        {
          ...
          quote: 'Working with NEWFRAME was refreshingly straightforward. No fluff, no endless revisions. Jed understood what we needed and delivered something that actually elevated our brand. The site works harder for us than our old one ever did.',
  ...
  pl: {
    ...
    hero: {
      ...
      subcopy: 'NEWFRAME to niezależne digital studio tworzące charakterystyczne strony, identyfikacje cyfrowe i doświadczenia produktowe dla founderów oraz rozwijających się firm.',
      primaryCta: 'Wyślij swoją obecną stronę',
      secondaryCta: 'Zobacz projekty',
    },
    about: {
      label: 'O STUDIO',
      manifesto: `NEWFRAME to niezależne digital studio tworzące ostre, charakterystyczne strony i identyfikacje cyfrowe dla founderów oraz rozwijających się firm. Pracujemy z markami, które rozumieją, jak mocno percepcja wpływa na zaufanie, cenę i wzrost.`,
      manifestoHighlights: ['NEWFRAME', 'digital', 'studio', 'percepcja'],
    ...
    testimonials: {
      ...
      items: [
        {
          lead: 'Strona przekonała ich, zanim jeszcze przyszli na miejsce.',
          quote: 'NEWFRAME wzięło naszą wizję i zamieniło ją w coś, czym naprawdę chcemy się chwalić. Strona wygląda jak my, nie jak kolejny szablon z naszym logo. Klienci mówią nam, że strona przekonała ich do nas zanim w ogóle do nas przyszli.',
        ...
        },
        {
          ...
          quote: 'Współpraca z NEWFRAME była odświeżająco prosta. Bez lania wody, bez niekończących się poprawek. Jed zrozumiał czego potrzebujemy i dostarczył coś, co naprawdę podniosło naszą markę. Nowa strona pracuje dla nas lepiej niż stara kiedykolwiek to robiła.',
